...
/datum/gear/eyes/materialaviators
	...
	allowed_roles = list("Engineer","Atmospheric Technician","Engineering Foreman","Engineering Apprentice","Miner")

/datum/gear/eyes/mesonaviators
	display_name = "aviators, meson"
	path = /obj/item/clothing/glasses/meson/aviator
	allowed_roles = list("Engineer","Atmospheric Technician","Engineering Foreman","Engineering Apprentice", "Research Director","Scientist", "Miner")
...
/datum/gear/eyes/medical
	...
	allowed_roles = list("Physician", "Surgeon", "Head Physician", "Chemist", "Paramedic", "Psychiatrist", "Medical Resident")
...
/datum/gear/eyes/shades
	...
	allowed_roles = list("Security Contractor", "Ranger Lieutenant", "Ranger", "Overseer", "Operations Manager", "Restaurant Manager", "Internal Affairs Agent", "Security Lead", "Forensic Technician")
...
/datum/gear/eyes/weldpatch
	...
	allowed_roles = list("Engineer","Atmospheric Technician","Engineering Foreman","Engineering Apprentice","Research Director","Roboticist")
	cost = 2
